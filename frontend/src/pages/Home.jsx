...
/**
 * Home — one-page centered storytelling with deep-cyan Prism inspiration.
 */
  ...
  return (
    <main className="relative bg-nuit">
      ...
      >
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(4,7,15,0)_0%,rgba(4,7,15,0.6)_60%,#04070F_100%)]" />
